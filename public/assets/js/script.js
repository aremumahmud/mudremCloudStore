var fileTypes = ['pdf', 'docx', 'rtf', 'jpg', 'jpeg', 'png', 'txt' ,"js" ,"css"];  //acceptable file types
var count = 2
...
$(document).ready(function(){
     document.getElementById("spaceId").value= localStorage.getItem("spaceId")
   ...
   $(".btn-new").on('click',function(){
        $("#uploader").append(`<div class="row uploadDoc"><div class="col-sm-3"><div class="docErr">Please upload valid file</div><!--error--><div class="fileUpload btn btn-orange"> <img src="https://image.flaticon.com/icons/svg/136/136549.svg" class="icon"><span class="upl" id="upload">Upload document</span><input type="file" name="image${count}" class="upload up" id="up" onchange="readURL(this);" /></div></div><div class="col-sm-8"><input type="text" class="form-control" name="note${count}" placeholder="Note"></div><div class="col-sm-1"><a class="btn-check"><i class="fa fa-times"></i></a></div></div>`);
        count++
   });
